#' A Function to knit NKO Markdown Reports
#'
...
nko_report <- function(toc = FALSE, toc_depth = 3, fig_width = 5, fig_height = 4, fig_caption = TRUE, df_print = "default", highlight = "default", reference_docx = system.file("rmarkdown/templates/resources/Analyses_R_Reference_Doc_2017_10_04.docx", package = "NKOMarkdownTemplate"), keep_md = FALSE, md_extensions = NULL, pandoc_args = NULL) {
